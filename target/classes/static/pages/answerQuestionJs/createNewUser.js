...
function changeTitle() {
    ...
    if (userTitle == '创建') {
        ...
        $('#createBtn').click(function() {
            ...
            if (userName == "") {
                ...
                commonAjaxPost(true, url, data, function(result) {
                    if (result.code == "666") {
                        commonAjaxPost(true, '/admin/addUserInfo', data, function(result) {})
        ...
        if (userTitle == '重置密码')
            $('#noPassword').css('display', 'block');
        else $('#noPassword').css('display', 'none');
        var userId = getCookie('userId');
        var editUserName = getCookie('editUserName')
        var url = '/redis/selectUserInfoByUserName';
        var data = {
            'id': userId,
        ...
        commonAjaxPost(true, url, data, function(result) {
            ...
            if (result.code == "666") {
                ...
                $("#config-demo").val(timeFormat(userInfo.startTime) + " ~ " + timeFormat(userInfo.stopTime));
        ...
        $('#createBtn').click(function() {
            ...
            if (userName == "") {
                ...
                commonAjaxPost(true, url, data, function(result) {
                    //console.log(result)
                    if (result.code == "666") {
                        commonAjaxPost(true, '/admin/modifyUserInfo', data, function(result) {})
